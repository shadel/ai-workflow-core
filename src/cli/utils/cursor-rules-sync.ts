 ...
 * @requirement v3.0+ - All mdc files including 000 and 004
 */
export const MDC_FILES = [
  '000-current-state-enforcement.mdc',  // v3.0: Hybrid static guide
  '001-workflow-core.mdc',
  '002-workflow-states.mdc',
  '003-workflow-validation.mdc',
  '004-workflow-commands.mdc'  // v3.1.1: Command discovery for Cursor
] as const;
