...
// Note: Using export * instead of export type * because we need both types and values
// (e.g., normalizeState is a function, not just a type)
export * from '@shadel/workflow-core';
...
export { registerMigrateCommand } from './cli/commands/migrate.js';
