...
export class TaskCompletionService {
   ...
   */
  async completeTask(options?: { autoActivateNext?: boolean }): Promise<TaskCompletionResult> {
    ...
    // Pass options to queue manager for auto-activate control
    const result = await this.queueManager.completeTask(activeTask.id, options);
