...
import os from 'os';
import { completeReviewChecklist, getUniqueAIContextDir, cleanupWithRetry } from '../test-helpers.js';
...
describe('Task Sync Conflicts - Fix Tests', () => {
  ...
  describe('Fix 6: updateTaskState() - Atomic sync', () => {
    ...
    }, 20000); // Increased timeout for full workflow integration test (parallel execution overhead)
