...
describe('ContextInjector - State-Based Patterns', () => {
  ...
  describe('State-based pattern injection', () => {
    ...
    it('should show mandatory patterns before recommended', async () => {
      ...
      // Recommended should NOT be shown when MANDATORY exists (noise reduction)
      // @see packages/workflow-core/src/core/pattern-provider.ts line 294
      expect(recommendedPos).toBe(-1);
