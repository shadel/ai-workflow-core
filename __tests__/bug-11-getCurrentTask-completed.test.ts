...
describe('Bug #11: getCurrentTask() with Completed Tasks', () => {
  ...
  beforeEach(async () => {
    ...
    // Clean test directory with retry for Windows file locking
    try {
      ...
      // Ignore cleanup errors - directory might not exist or be locked
    }
  ...
  describe('Workflow Compliance', () => {
    ...
    }, getTestTimeout() * 3); // Use enhanced timeout for multiple operations on Windows
  });
