export default {
  ...
  // Default timeout for all tests and hooks
  // setup.ts will override this with enhanced Windows-aware timeout
  testTimeout: process.env.CI ? 15000 : 5000,  // Base timeout
  ...
  resetMocks: true,
  restoreMocks: true,
  // Setup file to set NODE_ENV=test for all tests
