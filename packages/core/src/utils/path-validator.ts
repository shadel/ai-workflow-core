...
export class PathValidator {
   ...
   */
  validate(targetPath: string): { valid: boolean; error?: string } {
  ...
  // Note: exists() removed to keep foundation pure (no fs dependency)
  // Consumers should use fs-extra directly if needed
}
